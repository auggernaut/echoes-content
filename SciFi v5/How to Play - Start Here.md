# 🎴 Facilitator Guide: Waking Local
## *A GM’s First-Session Script*

This guide is designed for the **Game Master (GM)** to read aloud and follow at the table. By following these steps, you will teach your players the rules while simultaneously playing through the first scene of **The Stalker's Shadow**.

---

## 🛠 Step 1: Physical Setup
**GM Action**: *Set the physical components of the game. Do not start the story yet.*

1.  **Select Scenario**: Choose a scenario to play. For this walkthrough, we are using **The Stalker's Shadow**.
2.  **Filter the Adventure Deck**: The Adventure Deck contains four card types: **Locations**, **NPCs**, **Threats**, and **Loot**. For this specific adventure, find the following cards and put the rest aside—they won't be needed for this session:
    *   **Locations**: Cargo Hold, The Gut (Maintenance), Cryo Bay Theta.
    *   **NPCs**: Kira (The Stowaway), Specialist Aris.
    *   **Threats**: The Stalker.
    *   **Loot**: Bio-Scanner, Universal Multi-Tool.

---

## 🛠 Step 2: Introduction
**Read Aloud**: 
> *"Welcome to the ship. We are playing **SciFi v5**, a game of horror and hard choices. You are the crew of a deep-space vessel. Something has gone wrong, and your survival depends on the gear you carry and the choices you make. There are no safe corners here."*
...
**Read Aloud**:
> *"Look at your deck. You have a **5-slot loadout**. To build your starting hand, pick **one [DEFENSE]** card, **one [BOON]** card, and any **3 other cards** ([ITEM] or [ABILITY]) for a total of 5. These are the tools you woke up with."*

---

## 🛠 Step 4: The Hook
**GM Action**: *Read the Hook from the scenario guide. Use it to set the mood.*

**Read Aloud**:
> *"The emergency lighting flickers, then dies with a dry, mechanical click. In the sudden oppressive silence, the air feels heavier. Something has moved the cargo in the corridor ahead—not with a crash, but with a slow, grinding deliberate weight."*

**GM Action**: *Establish character stakes immediately using **Hook Questions**.*
...
**GM Action**: *Draw the **Cargo Hold** Location card. Keep the back hidden from players.*
...
## 🛠 Step 6: The First Action (Resolving Conflict)
**Read Aloud to the Table**:
> *"You hear that scratching again. It's closer. Someone needs to find out where it's coming from. **What do you do?**"*
...
3.  **The Roll**:
    ...
    *   **Standard**: Roll **1d6**.
4.  **Narrate the Consequence**: If they fail, don't just say 'nothing happens.' Say: *"The scanner glitches—you don't see the threat, but it definitely sees you. Something drops from the ceiling."*

---

## 🛠 Step 7: Conflict & Damage
**GM Action**: *Reveal **The Stalker** Threat card.*
...
## 🏁 Step 8: Play On
**Read Aloud**:
> *"The rules are in your hands now. I will continue to weave the scenario, and you will continue to survive. Let's see who makes it to the endgame."*
