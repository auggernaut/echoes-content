...
## **Hook Questions**
1. *Why does the smell of wet earth make you feel more sick than relieved?*
...
*   **The Gut (Maintenance)**: **Scalding steam bursts** (Hazard) occur where vines have crushed the pipes. A **Makeshift Nest** (Reveal) shows the predator is evolving.
...
*   **Apex Predator**: Use its **Terrifying Mimic** ability to project the voices of trapped crew members from the **Hydroponics Wing**. If players are Paralyzed by fear, have the Predator focus its **Multi-Strike** on the most armored PC to "prove dominance."

## **Endings**
*   **The Scorch**: The **Thermal Siphon** (Loot) is used to flash-freeze or incinerate the growth, saving the ship but destroying the food supply.
*   **The Hybrid**: Dr. Varn's research is used to "stabilize" the growth. The ship lives, but it now requires organic "nutrients" every cycle to generate oxygen.
