...
## **Hook (Read Aloud)**
*"Without warning, the deck vibrates with a deep, floor-shaking thud. The standard white illumination shifts to a flickering, high-alert red, but no sirens follow. One by one, the bulkheads start to hiss shut, sealing the ship into a series of isolated boxes. The comms are open, but they carry only the sound of rhythmic, synchronized breathing—followed by a voice you recognize, issuing a command for a security code that hasn't been used in years."*

## **Hook Questions**
1. *What did Senn do during the last inspection that made you realize he was breaking?*
...
## **Endings**
*   **The Restoration**: Senn is neutralized and the **AI Memory Shard** (Loot) is returned to the Core, restoring the original personality of the ship's AI.
*   **The Exile**: The PCs seize a shuttle, leaving the ship under Senn's control. They are free, but the "Corporate Bounty" on their heads has just gone active.
